package com.wachi.music.appshortcuts.shortcuttype;
...
import com.wachi.music.appshortcuts.AppShortcutLauncherActivity;

@TargetApi(Build.VERSION_CODES.N_MR1)
public abstract class BaseShortcutType {

    static final String ID_PREFIX = "com.wachi.music.appshortcuts.id.";
