package com.wachi.musicplayer.appshortcuts.shortcuttype;
...
import com.wachi.musicplayer.appshortcuts.AppShortcutLauncherActivity;

@TargetApi(Build.VERSION_CODES.N_MR1)
public abstract class BaseShortcutType {

    static final String ID_PREFIX = "com.wachi.musicplayer.appshortcuts.id.";
