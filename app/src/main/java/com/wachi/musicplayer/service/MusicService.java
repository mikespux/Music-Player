package com.wachi.musicplayer.service;
...
import com.wachi.musicplayer.appwidgets.AppWidgetBig;
import com.wachi.musicplayer.appwidgets.AppWidgetCard;
import com.wachi.musicplayer.appwidgets.AppWidgetCardDark;
import com.wachi.musicplayer.appwidgets.AppWidgetClassic;
import com.wachi.musicplayer.appwidgets.AppWidgetClassicDark;
import com.wachi.musicplayer.appwidgets.AppWidgetSmall;
import com.wachi.musicplayer.appwidgets.AppWidgetSmallDark;
import com.wachi.musicplayer.glide.BlurTransformation;
import com.wachi.musicplayer.glide.SongGlideRequest;
import com.wachi.musicplayer.helper.ShuffleHelper;
import com.wachi.musicplayer.helper.StopWatch;
...
import com.wachi.musicplayer.provider.MusicPlaybackQueueStore;
import com.wachi.musicplayer.provider.SongPlayCountStore;
import com.wachi.musicplayer.service.notification.PlayingNotification;
import com.wachi.musicplayer.service.notification.PlayingNotificationImpl;
import com.wachi.musicplayer.service.notification.PlayingNotificationImpl24;
import com.wachi.musicplayer.service.playback.Playback;
import com.wachi.musicplayer.util.MusicUtil;
import com.wachi.musicplayer.util.PreferenceUtil;
import com.wachi.musicplayer.util.Util;
...
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener, Playback.PlaybackCallbacks {
    ...
    public static final String MUSIC_PACKAGE_NAME = "com.wachi.musicplayer";
    ...
    public void onCreate() {
        ...
        sendBroadcast(new Intent("com.wachi.musicplayer.MUSIC_SERVICE_CREATED"));
    }
    ...
    private void setupMediaSession() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
            mediaButtonReceiverPendingIntent = PendingIntent.getBroadcast
    ...
    public void onDestroy() {
        ...
        sendBroadcast(new Intent("com.wachi.musicplayer.MUSIC_SERVICE_DESTROYED"));
    }
